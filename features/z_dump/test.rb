...
str1="wxcodebuild SRCROOT='/Users/tejasvi.manmatha/projects/meine.tui/build/iphone' ARCHS='#{ARCHITECTURE_SELECTED}' ONLY_ACTIVE_ARCH=NO -sdk iphonesimulator  -configuration '#{BUILD_CONFIG}' -showBuildSettings"
res=`#{str1}`
